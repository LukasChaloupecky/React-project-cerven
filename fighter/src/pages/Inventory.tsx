...
const Inventory = () => {
    ...
    const [{isOver}, drop] = useDrop({
        ...
        drop: (item : {index : number}) => {
            ...
            // ! dispatch({type: ActionEnum.CHANGE_ARMOR, ARMOR_INDEX: item});
        },
        collect: (monitor) => ({
    ...
    return (
        ...
        <div ref={drop} style={{backgroundColor: isOver ? "green" : "white", width: "100px", height: "100px"}}>hsdfhfsdfhjsdfhjhjfhjsdfhjfhjaff</div>
